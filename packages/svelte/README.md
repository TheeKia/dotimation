...
Content, dots, motion, backend, matching, reduced-motion and stats options match the React component. The shared `@kiaa/dotimation-core` dependency is installed automatically; React is not required.
