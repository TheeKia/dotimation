...
1. Write and commit reviewed notes at `docs/releases/<version>.md`, covering user-facing changes and affected adapters. Alternatively, import an external Markdown file with `--notes <file>`.
